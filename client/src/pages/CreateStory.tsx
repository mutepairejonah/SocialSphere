  ...
  return (
    <div className="pb-20 max-w-md mx-auto min-h-screen bg-background">
      ...
      <main className="p-4 space-y-3">
        ...
        <div className="aspect-[9/16] bg-gradient-to-b from-muted to-muted/50 rounded-2xl overflow-hidden flex items-center justify-center border border-border shadow-lg relative">
          {mediaUrl ? (
            <>
              {mediaType === 'video' ? (
